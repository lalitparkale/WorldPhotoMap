...
if __name__ == "__main__":
    ...
    if (os.path.isdir(folder_to_scan)):
        def open_photo_map(folder_to_scan = folder_to_scan):

            FilesInfo = {}
            def SearchAllPics(pathToSearch = folder_to_scan):
            ...
            #\2016-03
            #FilesInfo = SearchAllPics(folder_to_scan)
            locations = ""
            for k, v in FilesInfo.items():
        ...
        print ("You entered invalid folder path. Enter a valid directory path")
        folder_to_scan = input("Enter a dir path : ")
